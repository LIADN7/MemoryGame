...
export default class MainScene extends Phaser.Scene {
	...
	private bg!: Phaser.GameObjects.Image; // The background img
	private symbol11!: Phaser.GameObjects.Sprite; // All the symbols of the game
	...
	private restartSymbol!: Phaser.GameObjects.Image; // Reset img
	private tipSymbol!: Phaser.GameObjects.Image; // Tip img
	private limitText!: Phaser.GameObjects.Text; // A text: The number of possible errors
	private feedbackText!: Phaser.GameObjects.Text; // A text: The feedback of the game
	private timeLimitText!: Phaser.GameObjects.Text; // A text: The Timer
	private leaderboardText!: Phaser.GameObjects.Text[]; // A text: The Timer
	private mainSounds!: Phaser.Sound.BaseSound; // Main sound
	public timeLimit!: number;
	public timerGame!: number;
	...
	update(time: number, delta: number): void {
		...
		if(this.timerGame>0){
			...
			if(this.timeLimit==0) this.feedbackText.setText("You Won!");
			else this.feedbackText.setText("Game Over");
		}
